...
public class TeamCalendarServiceTest extends LogicTestEnv{
	private static final Logger logger = LoggerFactory.getLogger(TeamCalendarServiceTest.class);
	...
	*/
	...
	public void insertCalTest() throws ParseException {
		...
		int result = service.insertCal(tcVO);
	...
	*/
	...
	public void deleteCalTest() {
		...
		int result = service.deleteCal(maxSequence);
