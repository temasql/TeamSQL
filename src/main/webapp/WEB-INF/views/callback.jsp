		...
		window.addEventListener('load', function () {
			naverLogin.getLoginStatus(function (status) {
				if (status) {
					...
					window.location.replace("http://" + window.location.hostname + ( (location.port==""||location.port==undefined)?"":":" + location.port) + "/user/signIn?user_email=" + email + "&user_name=" + name + "&user_path=" + profileImage);
				} else {
