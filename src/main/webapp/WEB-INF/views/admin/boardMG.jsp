...
<div class="col-sm-8 blog-main">
	...
	action="${cp }/board/addBoard" method="post">
		...
		<input type="text" class="form-control mb-2 mr-sm-2" id="boardName" 
		name="board_name" 	placeholder="게시판명"> 
			...
			<table class="table table-striped">
				...
				<c:forEach items="${boardList }" var="board">
					<tr class="boardTr">
						...
						<td class="modiSel"><select class="form-control updateUse_yn" 	name="use_yn">
								<c:choose>
