...
<div id="gruopDiv">
	<form id="insertOXDB" action="/insertOX" method="post" >
		<div id="question">문제 :<input class="form-control" id="question" name="quiz_question" type="text"></div>
		<div id="answer">답 : <input type="radio" name="quiz_answer" value="O" checked/>&nbsp;O &nbsp;&nbsp;<input type="radio" name="group" value="X"/>&nbsp;X</div>
